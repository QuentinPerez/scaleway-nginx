Official nginx image on Online Labs [![Build Status](https://travis-ci.org/online-labs/image-app-nginx.svg?branch=master)](https://travis-ci.org/online-labs/image-app-nginx)
===================================

Scripts to build the official nginx image on Online Labs
...
<img src="http://upload.wikimedia.org/wikipedia/commons/c/c6/NginxLogo.gif" width="121px" />
